...
<style scoped>
  ...
  .calculator-promo__highlight-text {
    color: var(--tm-white);
    text-shadow:
      2px 0 var(--tm-shadow),
      -2px 0 var(--tm-shadow),
